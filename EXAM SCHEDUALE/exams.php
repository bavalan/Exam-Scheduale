...
the exam scheduale by course code and return the information to myexams.js, which
...
*/ 
	...
	where the user $input matches the info in the course column*/
	$sql = "SELECT*FROM courses WHERE course LIKE '".$input."%';";
